    ...
    <div class="product-container">
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=1">add to cart</a></button>
          </div>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=2">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">CASIO G-SHOCK</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=3">add to cart</a></button>
          </div>
          <div class="product-info">
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=4">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">FOSSIL</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=5">add to cart</a></button>
          </div>
          <div class="product-info">
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=6">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">SEIKO</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=7">add to cart</a></button>
          </div>
          <div class="product-info">
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=8">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">TISSOT</h2>
    ...
    <div class="product-container">
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=9">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">TISSOT</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=10">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">FOSSIL</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=11">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">CASIO G-SHOCK</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=12">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">TISSOT</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=13">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">FOSSIL</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=14">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">SEIKO</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=15">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">CASIO G-SHOCK</h2>
      ...
      <div class="product-card">
          <div class="product-image">
              ...
              <button class="card-btn"><a href="shoppingcart.php?product_id=16">add to cart</a></button>
          </div>
          <div class="product-info">
              <h2 class="product-brand">SEIKO</h2>
